...
import '../../../profile/presentation/manager/currency_cubit.dart';
    ...
    return BaseLayout(
      ...
      child: Column(
        ...
        children: [
          ...
          //     return Text(
          //         context.read<CurrencyCubit>().convert(price)
          //     );
          //   },
          // )
          // Text(context.read<CurrencyCubit>().convert(500)),
          BlocBuilder<CurrencyCubit, String>(
            builder: (context, state) => Text(
                context.read<CurrencyCubit>().convert(500)
            ),
          ),
