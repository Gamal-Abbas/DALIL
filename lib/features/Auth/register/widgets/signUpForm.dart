...
class Signupform extends StatelessWidget {
  ...
  const Signupform({super.key, required this.formKey, required this.nameController, required this.emailController, required this.passwordController, required this.confirmPasswordController, required this.onFieldSubmitted});
  ...
  Widget build(BuildContext context) {
    return Form(
      key: formKey,
      child: Column(
        spacing: (MediaQuery.sizeOf(context).height)/40,
        children: [
